<template>
  <div>
    <div v-if="open">
      <b-button variant="outline-primary" @click="open = !open" class="mb-3">
        Yeni XSLT Ekle
      </b-button>
      <app-table
    ...
    <div v-else>
      <b-button variant="outline-primary" @click="open = !open" class="mb-2">
        Geri
      </b-button>
      <b-row>
        <b-col cols="4">
          <b-card>
            <h3>Notlar</h3>
            <Repeater v-model="notlar" />
          </b-card>

          <b-card>
            <h3>Banka</h3>
            <Repeater v-model="banka" />
          </b-card>
          <b-card>
            <span>{{ file1 }}</span>
            <h3>Firma Logosu</h3>
                  ...
                  <tr valign="top">
                    ...
                    <td align="right">
                      ...
                      <div
                        ...
                        id="qrvalue"
                      >
                        {"tur":"E-Fatura", "VKNTCKN":"8200152638",
                        "unvan":"VURAL TANIR ", "senaryo":"EARSIVFATURA",
                        "tip":"SATIS", "tarih":"2022-03-08",
                        "no":"GIB2022000000017",
                        "ETTN":"4a539c92-e7cf-412b-adeb-eb37e5f193c2",
                        "malHizmetKDV(18)":68.64, "hesaplananKDV(18)":12.35,
                        "malHizmet":68.64, "vergidahil":"80.99",
                        "odenecek":"80.99"}
                      </div>
                      <span>{{ logo.img }}</span>
                      <img
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td align="left" style="width: 469px">
                                      ...
                                      }}<br />Kapı No:{{ person.adress.DaireNo
                                      }}<br />{{ person.adress.city }}/{{
                                        person.adress.İlce
                                      }}/Türkiye
                                    </td>
                                  </tr>
                                  <tr align="left">
                                    <td>
                                      Web Sitesi:{{ person.adress.Website }}
                                    </td>
                                  </tr>
                                  <tr align="left">
                                    <td>E-Posta:{{ person.adress.EPosta }}</td>
                ...
                <tbody>
                  <tr class="lineTableTr">
                    ...
                    <td align="center" style="width: 7%" class="lineTableTd">
                      <span style="font-weight: bold"
                        >İskonto/ Arttırım Oranı</span
                      >
                    </td>
                    <td align="center" style="width: 9%" class="lineTableTd">
                      <span style="font-weight: bold"
                        >İskonto/ Arttırım Tutarı</span
                      >
                    </td>
                    <td align="center" style="width: 9%" class="lineTableTd">
                      <span style="font-weight: bold"
                        >İskonto/ Arttırım Nedeni</span
                      >
                    </td>
                    <td align="center" style="width: 7%" class="lineTableTd">
