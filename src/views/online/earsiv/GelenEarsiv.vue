...
export default {
  ...
  computed: {
    ...
    ...mapGetters["GetGelenArsiv"],
    getFatura() {
      return this.GetGelenArsiv;
    },
  },
  ...
  methods: {
    ...
    ...mapActions(["FecthGelenFaturalar"]),
    fetch() {
      this.FecthGelenFaturalar(kullaniciId).then((res) => {
        console.log(res);
        this.items = res;
        this.items.forEach((element) => {
          console.log(element);
          this.toplamMatrah += element.Toplam;
          this.vergiToplam += element.Vergiler;
          this.odenecekToplam += element.Odenecek;
        });
      });
    },
  },
